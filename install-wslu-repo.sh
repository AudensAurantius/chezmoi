...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/whitewaterfoundry/wslu/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/whitewaterfoundry/wslu/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/whitewaterfoundry_wslu.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    install -d -m 0755 "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/whitewaterfoundry_wslu-archive-keyring.gpg"
    gpg_key_path_old="/etc/apt/trusted.gpg.d/whitewaterfoundry_wslu.gpg"
